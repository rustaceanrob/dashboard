    ...
    <div className='flex text-white col-span-3 justify-center items-center'>
        <form role="search" method="get" id="searchform" class="searchform" action="http://www.google.co.uk/search?hl=en-GB&source=hp&q=">
          <span className='flex flex-row justify-center items-center'>
            ...
            <input type="text" name="q" className='font-lato text-lg dark:bg-gray-800/80 bg-white/80 text-black rounded-xl px-4 py-1 dark:text-white shadow-lg shadow-gray-400 justify-center items-center focus:outline-none'></input>
          </span>
        </form>
    </div>
  )
